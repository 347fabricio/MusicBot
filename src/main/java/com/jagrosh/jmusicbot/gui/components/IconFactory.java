...
public final class IconFactory
{
	...
	public enum IconType {
		// Status icons
		CONNECTED("connected", "icons/connected.svg"), DISCONNECTED("disconnected", "icons/disconnected.svg"),

		// Tab icons
		CONSOLE("console", "icons/console.svg"), STATUS("status", "icons/status.svg"),
		SETTINGS("settings", "icons/settings.svg"),

		// Action icons
		PLAY("play", "icons/play.svg"), PAUSE("pause", "icons/pause.svg"), STOP("stop", "icons/stop.svg"),
		SKIP("skip", "icons/skip.svg"), VOLUME("volume", "icons/volume.svg"),

		// Misc icons
		SEARCH("search", "icons/search.svg"), CLEAR("clear", "icons/clear.svg"), COPY("copy", "icons/copy.svg"),
	...
	/**
	 * Gets a FlatLaf built-in icon by name. These icons are included with FlatLaf
	 * and adapt to the current theme.
	 *
